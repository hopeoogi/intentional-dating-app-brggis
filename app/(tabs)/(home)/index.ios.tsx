...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    console.log('iOS Daily matches count:', limitedMatches.length);
    setDailyMatches(limitedMatches);
  }, [subscriptionTier, matchFilters]);

  const handleStartConversation = () => {
    console.log('iOS Start conversation pressed');
  ...
  const handleViewProfile = () => {
    console.log('iOS View profile pressed');
    router.push('/profile-detail');
  };

  const handlePass = () => {
    console.log('iOS Pass pressed');
  ...
  const handleOpenFilters = () => {
    console.log('iOS Open filters pressed');
