      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.placeholderContainer}>
          ...
          <Text style={styles.placeholderText}>
            This feature requires Supabase backend integration. Enable Supabase to manage pending
            user approvals, review applications, and approve or reject new members.
          </Text>
        </View>
      </ScrollView>
    </View>
